...
import { Mail, Linkedin, MapPin, Phone, Heart, Camera } from "lucide-react"
        ...
        <header className="relative border-2 border-black mb-8 overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between p-6 md:p-12">
            ...
            <div className="grid grid-cols-1 gap-3">
              ...
              <Button
                variant="outline"
                className="border-2 border-black hover:bg-orange-500 hover:text-white hover:border-orange-500 transition-colors"
              >
